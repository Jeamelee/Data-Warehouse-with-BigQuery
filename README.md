...
SQL                              Used for dimensional modeling, ETL scripting, and generating all business intelligence reports.

Dimensional Modeling             Implemented a Star Schema consisting of the Sales Fact Table and multiple Dimension Tables.

ETL Process                     Focused on extracting data from source tables, transforming it 
                                into a dimensional structure, and loading it into the BigQuery                                   
                                warehouse.
